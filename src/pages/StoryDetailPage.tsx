...
import { gingerbreadStoryEnGB, gingerbreadStoryEnUS, gingerbreadStoryFR, gingerbreadStoryES, gingerbreadStoryDE, gingerbreadStoryIT, gingerbreadStoryPT, gingerbreadStoryNL, gingerbreadStoryPL } from '../data/gingerbreadStory';
...
const StoryDetailPage: React.FC = () => {
  ...
  const [selectedLanguage, setSelectedLanguage] = useState<'en-GB' | 'en-US' | 'fr' | 'es' | 'de' | 'it' | 'pt' | 'nl' | 'pl'>('en-GB');
              ...
              <>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setSelectedLanguage(e.target.value as 'en-GB' | 'en-US' | 'fr' | 'es' | 'de' | 'it' | 'pt' | 'nl' | 'pl')}
