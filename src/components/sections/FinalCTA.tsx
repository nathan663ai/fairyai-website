    ...
    <section className="py-16 md:py-24 bg-gradient-to-br from-soft-blue-600 to-soft-green-600 text-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg mb-8 text-white font-semibold">
          Try FairyAI free today. No signup needed to explore.
        </p>
        ...
        <div className="mb-6 scale-125 transform">
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
            ...
            >
              <div className="bg-white text-black px-6 py-3 rounded-lg flex items-center gap-3 min-w-[180px] shadow-xl hover:shadow-2xl">
