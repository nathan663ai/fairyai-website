 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(S,_){var M=S.length;S.push(_);e:for(;0<M;){var $=M-1>>>1,K=S[$];if(0<i(K,_))S[$]=_,S[M]=K,M=$;else break e}}function n(S){return S.length===0?null:S[0]}function r(S){if(S.length===0)return null;var _=S[0],M=S.pop();if(M!==_){S[0]=M;e:for(var $=0,K=S.length,ba=K>>>1;$<ba;){var Et=2*($+1)-1,Qr=S[Et],Pt=Et+1,ka=S[Pt];if(0>i(Qr,M))Pt<K&&0>i(ka,Qr)?(S[$]=ka,S[Pt]=M,$=Pt):(S[$]=Qr,S[Et]=M,$=Et);else if(Pt<K&&0>i(ka,M))S[$]=ka,S[Pt]=M,$=Pt;else break e}}return _}function i(S,_){var M=S.sortIndex-_.sortIndex;return M!==0?M:S.id-_.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;e.unstable_now=function(){return s.now()}}else{var l=Date,o=l.now();e.unstable_now=function(){return l.now()-o}}var u=[],d=[],g=1,f=null,p=3,v=!1,x=!1,w=!1,k=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function h(S){for(var _=n(d);_!==null;){if(_.callback===null)r(d);else if(_.startTime<=S)r(d),_.sortIndex=_.expirationTime,t(u,_);else break;_=n(d)}}function b(S){if(w=!1,h(S),!x)if(n(u)!==null)x=!0,Vr(N);else{var _=n(d);_!==null&&Zr(b,_.startTime-S)}}function N(S,_){x=!1,w&&(w=!1,m(E),E=-1),v=!0;var M=p;try{for(h(_),f=n(u);f!==null&&(!(f.expirationTime>_)||S&&!pe());){var $=f.callback;if(typeof $=="function"){f.callback=null,p=f.priorityLevel;var K=$(f.expirationTime<=_);_=e.unstable_now(),typeof K=="function"?f.callback=K:f===n(u)&&r(u),h(_)}else r(u);f=n(u)}if(f!==null)var ba=!0;else{var Et=n(d);Et!==null&&Zr(b,Et.startTime-_),ba=!1}return ba}finally{f=null,p=M,v=!1}}var C=!1,L=null,E=-1,F=5,P=-1;function pe(){return!(e.unstable_now()-P<F)}function Sn(){if(L!==null){var S=e.unstable_now();P=S;var _=!0;try{_=L(!0,S)}finally{_?Ln():(C=!1,L=null)}}else C=!1}var Ln;if(typeof c=="function")Ln=function(){c(Sn)};else if(typeof MessageChannel<"u"){var zl=new MessageChannel,Tc=zl.port2;zl.port1.onmessage=Sn,Ln=function(){Tc.postMessage(null)}}else Ln=function(){k(Sn,0)};function Vr(S){L=S,C||(C=!0,Ln())}function Zr(S,_){E=k(function(){S(e.unstable_now())},_)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(S){S.callback=null},e.unstable_continueExecution=function(){x||v||(x=!0,Vr(N))},e.unstable_forceFrameRate=function(S){0>S||125<S?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):F=0<S?Math.floor(1e3/S):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return n(u)},e.unstable_next=function(S){switch(p){case 1:case 2:case 3:var _=3;break;default:_=p}var M=p;p=_;try{return S()}finally{p=M}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(S,_){switch(S){case 1:case 2:case 3:case 4:case 5:break;default:S=3}var M=p;p=S;try{return _()}finally{p=M}},e.unstable_scheduleCallback=function(S,_,M){var $=e.unstable_now();switch(typeof M=="object"&&M!==null?(M=M.delay,M=typeof M=="number"&&0<M?$+M:$):M=$,S){case 1:var K=-1;break;case 2:K=250;break;case 5:K=1073741823;break;case 4:K=1e4;break;default:K=5e3}return K=M+K,S={id:g++,callback:_,priorityLevel:S,startTime:M,expirationTime:K,sortIndex:-1},M>$?(S.sortIndex=M,t(d,S),n(u)===null&&S===n(d)&&(w?(m(E),E=-1):w=!0,Zr(b,M-$))):(S.sortIndex=K,t(u,S),x||v||(x=!0,Vr(N))),S},e.unstable_shouldYield=pe,e.unstable_wrapCallback=function(S){var _=p;return function(){var M=p;p=_;try{return S.apply(this,arguments)}finally{p=M}}}})(iu);ru.exports=iu;var nm=ru.exports;/**
 * @license React
...
THE END`,qg={title:"Whispers of the Tidal Star",imageUrl:"https://d1mmspri4wgcne.cloudfront.net/ai_stories/whispers-of-the-tidal-star-d5dfda26/cover.jpg",content:Mc,narrators:[{id:"echo",name:"Echo",duration:463,audioUrl:"https://d1mmspri4wgcne.cloudfront.net/ai_stories/whispers-of-the-tidal-star-d5dfda26/narrations/en-GB/echo.mp3"},{id:"nova",name:"Nova",duration:481,audioUrl:"https://d1mmspri4wgcne.cloudfront.net/ai_stories/whispers-of-the-tidal-star-d5dfda26/narrations/en-GB/nova.mp3"},{id:"onyx",name:"Onyx",duration:446,audioUrl:"https://d1mmspri4wgcne.cloudfront.net/ai_stories/whispers-of-the-tidal-star-d5dfda26/narrations/en-GB/onyx.mp3"},{id:"shimmer",name:"Shimmer",duration:478,audioUrl:"https://d1mmspri4wgcne.cloudfront.net/ai_stories/whispers-of-the-tidal-star-d5dfda26/narrations/en-GB/shimmer.mp3"}],songs:[{id:"singalong",title:"The Moon Path Song",style:"singalong",url:"https://musicfile.api.box/YzFlNDhjNGYtODFjYi00MjA2LTkwM2EtMjk3YmZmN2RiOGVm.mp3",duration:194,coverUrl:"https://musicfile.api.box/YzFlNDhjNGYtODFjYi00MjA2LTkwM2EtMjk3YmZmN2RiOGVm.jpeg"},{id:"epic_adventure",title:"The Moon Path",style:"epic_adventure",url:"https://musicfile.api.box/ZTcwZmMxMmEtMzFjMC00NmYwLWJjOTEtMDhiNDEzODFmYmQ5.mp3",duration:240,coverUrl:"https://musicfile.api.box/ZTcwZmMxMmEtMzFjMC00NmYwLWJjOTEtMDhiNDEzODFmYmQ5.jpeg"},{id:"magical_pop_rock",title:"Star Pebble Moon Path",style:"magical_pop_rock",url:"https://musicfile.api.box/ODM5YzBjNGItNGE3Ni00NzcwLWFhMzUtZjgyYzc0NzExZWI0.mp3",duration:145,coverUrl:"https://musicfile.api.box/ODM5YzBjNGItNGE3Ni00NzcwLWFhMzUtZjgyYzc0NzExZWI0.jpeg"},{id:"enchanted_synth_pop",title:"Star on the Shore",style:"enchanted_synth_pop",url:"https://musicfile.api.box/YTQzZjMzNWItM2E1My00YjE2LThmOGItM2ViZWVmNzMwNTNm.mp3",duration:155,coverUrl:"https://musicfile.api.box/YTQzZjMzNWItM2E1My00YjE2LThmOGItM2ViZWVmNzMwNTNm.jpeg"}]},Gg={title:"Whispers of the Tidal Star",imageUrl:"https://d1mmspri4wgcne.cloudfront.net/ai_stories/whispers-of-the-tidal-star-d5dfda26/cover.jpg",content:Mc,narrators:[{id:"echo",name:"Echo",duration:462,audioUrl:"https://d1mmspri4wgcne.cloudfront.net/ai_stories/whispers-of-the-tidal-star-d5dfda26/narrations/en-US/echo.mp3"},{id:"nova",name:"Nova",duration:479,audioUrl:"https://d1mmspri4wgcne.cloudfront.net/ai_stories/whispers-of-the-tidal-star-d5dfda26/narrations/en-US/nova.mp3"},{id:"onyx",name:"Onyx",duration:462,audioUrl:"https://d1mmspri4wgcne.cloudfront.net/ai_stories/whispers-of-the-tidal-star-d5dfda26/narrations/en-US/onyx.mp3"},{id:"shimmer",name:"Shimmer",duration:483,audioUrl:"https://d1mmspri4wgcne.cloudfront.net/ai_stories/whispers-of-the-tidal-star-d5dfda26/narrations/en-US/shimmer.mp3"}],songs:[{id:"singalong",title:"The Moon Path Melody",style:"singalong",url:"https://musicfile.api.box/M2MzNTUwYzMtYzE5Mi00ZWY3LWJiNzItMjkzNGRlMTRlMjU1.mp3",duration:189,coverUrl:"https://musicfile.api.box/M2MzNTUwYzMtYzE5Mi00ZWY3LWJiNzItMjkzNGRlMTRlMjU1.jpeg"},{id:"enchanted_synth_pop",title:"Moonlit Ripple Key",style:"enchanted_synth_pop",url:"https://musicfile.api.box/YmI4NzFjZTktOTVhYS00MWY4LWE2NzMtNGFhZjUyMGEyYzE0.mp3",duration:177,coverUrl:"https://musicfile.api.box/YmI4NzFjZTktOTVhYS00MWY4LWE2NzMtNGFhZjUyMGEyYzE0.jpeg"}]},$g=`Au bord de l'océan, là où le sable était frais et poudreux entre les orteils, le ciel du soir teintait l'eau d'un bleu-argenté. Les vagues chuchotaient un petit shhh, et de minuscules coquillages parsemaient la plage comme des bonbons.
